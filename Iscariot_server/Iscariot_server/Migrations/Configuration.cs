    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Iscariot_server.DAL.Iscariot_DB_Context>
    {
        ...
        protected override void Seed(Iscariot_server.DAL.Iscariot_DB_Context context)
        {
            List<Schedule> temp = new List<Schedule>
            {
                ...
                new Schedule{Id=Guid.NewGuid(), Faculty = "FMF", Specialty = "PIL", Section = "MIM", Term = 4, Monday_Ch = "1\t2\t3\t4", Monday_Z = "\t2\t3\t4", Tuesday_Ch = "1\t2\t\t", Tuesday_Z = "1\t2\t3\t4", Wednesday_Ch = "1\t2\t\t", Wednesday_Z = "\t\t3\t", Thursday_Ch = "1\t2\t\t", Thursday_Z = "1\t2\t\t", Friday_Ch = "1\t\t\t", Friday_Z = "1\t\t\t", Saturday_Ch ="\t\t\t", Saturday_Z="\t\t\t", Sunday_Ch ="\t\t\t", Sunday_Z = "\t\t\t" },
            };
